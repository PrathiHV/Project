// Automate with alert feature where "On button click, prompt box will appear" is working
...
public class Alerts2 extends BaseClass {
    ...
    public void element() throws Exception {
        ...
        try {
            ...
            alertsButton.click();
            WebElement windowButton = driver.findElement(By.id("promtButton"));
