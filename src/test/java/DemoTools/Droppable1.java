//Locate droppable and check acceptble and notacceptable tab can be drag and dropped.
...
public class Droppable1 extends BaseClass {
    ...
    public void testDragAndDrop() throws InterruptedException {
        ...
        WebElement source = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("acceptable")));
        WebElement target = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='Drop here']/../../../../div[2]/div/div[2]")));
        ...
        WebElement source1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("notAcceptable")));
        WebElement target1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='Drop here']/../../../../div[2]/div/div[2]")));
